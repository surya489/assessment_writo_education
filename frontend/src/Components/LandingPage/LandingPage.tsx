...
const LandingPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post('https://assessment-writo-education-api.vercel.app/userForm', { email, password, confirmPassword, contactMode, firstName, lastName }, { withCredentials: true });
    ...
    const handleVerify = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post('https://assessment-writo-education-api.vercel.app/otpVerify', { email, otp });
